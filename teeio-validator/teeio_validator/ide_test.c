...
ide_test_config_funcs_t m_config_funcs[IDE_TEST_TOPOLOGY_TYPE_NUM][IDE_TEST_CONFIGURATION_TYPE_NUM] = {
  { // selective_ide
    ...
    { // selective_ide_for_configuration
      test_config_sel_ide_for_config_req_enable,
      test_config_sel_ide_for_config_req_disable,
      test_config_sel_ide_for_config_req_support,
      test_config_sel_ide_for_config_req_check
    },
