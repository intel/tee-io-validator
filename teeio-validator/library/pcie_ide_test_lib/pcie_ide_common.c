...
)
{
  ...
  p->test_category = TEEIO_TEST_CATEGORY_PCIE_IDE;
  ...
  if(case_funcs->next == NULL) {
    case_funcs->test_category = TEEIO_TEST_CATEGORY_PCIE_IDE;
...
)
{
  ...
  if(config_funcs->next == NULL) {
    config_funcs->test_category = TEEIO_TEST_CATEGORY_PCIE_IDE;
...
)
{
  ...
  if(group_funcs->next == NULL) {
    group_funcs->test_category = TEEIO_TEST_CATEGORY_PCIE_IDE;
