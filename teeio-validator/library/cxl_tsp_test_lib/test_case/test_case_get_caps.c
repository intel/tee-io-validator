...
static const char* case_msg = "  Assertion 2.1";
    ...
    )
{
    ...
    if((te_state_change_and_access_control_features_supported & 
      ...
      TEEIO_PRINT(("         %s.7: %s %s\n", case_msg, mCxlTspGetCapsAssersion[7], "NA"));
    }
    ...
    if((te_state_change_and_access_control_features_supported &
      ...
      TEEIO_PRINT(("         %s.8: %s %s\n", case_msg, mCxlTspGetCapsAssersion[8], "NA"));
    }
    ...
    if(((te_state_change_and_access_control_features_supported &
      ...
      TEEIO_PRINT(("         %s.9: %s %s\n", case_msg, mCxlTspGetCapsAssersion[9], res ? "Pass" : "Fail"));
      if (!res) {
          return LIBSPDM_STATUS_INVALID_MSG_FIELD;
      }
    } else {
      TEEIO_PRINT(("         %s.9: %s %s\n", case_msg, mCxlTspGetCapsAssersion[9], "NA"));
    }
    ...
    if((te_state_change_and_access_control_features_supported &
      ...
      TEEIO_PRINT(("         %s.10: %s %s\n", case_msg, mCxlTspGetCapsAssersion[10], "NA"));
    }
