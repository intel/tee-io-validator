                                  ...
                                  )
{
  ...
  if(key_direction == CXL_IDE_KM_KEY_DIRECTION_RX
     || (dev_caps.ide_key_generation_capable == 0 && dev_caps.iv_generation_capable == 0)) {
    ...
    libspdm_return_t status = cxl_ide_km_get_key(pci_doe_context, spdm_context, session_id,
