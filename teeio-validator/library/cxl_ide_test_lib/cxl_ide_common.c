...
)
{
  ...
  p->test_category = IDE_TEST_CATEGORY_CXL_MEMCACHE;
  ...
  if(case_funcs->next == NULL) {
    case_funcs->test_category = IDE_TEST_CATEGORY_CXL_MEMCACHE;
...
)
{
  ...
  if(config_funcs->next == NULL) {
    config_funcs->test_category = IDE_TEST_CATEGORY_CXL_MEMCACHE;
...
)
{
  ...
  if(group_funcs->next == NULL) {
    group_funcs->test_category = IDE_TEST_CATEGORY_CXL_MEMCACHE;
