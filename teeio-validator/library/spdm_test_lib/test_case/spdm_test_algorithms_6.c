...
bool spdm_test_algorithms_6_setup(void *test_context)
{
  ...
  return m_spdm_test_group_algorithms[5].case_setup_func(&m_spdm_test_context);
}

bool spdm_test_algorithms_6_run(void *test_context)
{
  m_spdm_test_group_algorithms[5].case_func(&m_spdm_test_context);
  return true;
}

bool spdm_test_algorithms_6_teardown(void *test_context)
{
  m_spdm_test_group_algorithms[5].case_teardown_func(&m_spdm_test_context);
  return true;
}
