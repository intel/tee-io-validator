...
bool spdm_test_finish_6_setup(void *test_context)
{
  ...
  return m_spdm_test_group_finish_rsp[5].case_setup_func(&m_spdm_test_context);
}

bool spdm_test_finish_6_run(void *test_context)
{
  m_spdm_test_group_finish_rsp[5].case_func(&m_spdm_test_context);
  return true;
}

bool spdm_test_finish_6_teardown(void *test_context)
{
  m_spdm_test_group_finish_rsp[5].case_teardown_func(&m_spdm_test_context);
  return true;
}
