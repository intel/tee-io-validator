...
bool spdm_test_measurements_10_setup(void *test_context)
{
  ...
  return m_spdm_test_group_measurements[9].case_setup_func(&m_spdm_test_context);
}

bool spdm_test_measurements_10_run(void *test_context)
{
  m_spdm_test_group_measurements[9].case_func(&m_spdm_test_context);
  return true;
}

bool spdm_test_measurements_10_teardown(void *test_context)
{
  m_spdm_test_group_measurements[9].case_teardown_func(&m_spdm_test_context);
  return true;
}
