...
bool spdm_test_algorithms_7_setup(void *test_context)
{
  ...
  return m_spdm_test_group_algorithms[6].case_setup_func(&m_spdm_test_context);
}

bool spdm_test_algorithms_7_run(void *test_context)
{
  m_spdm_test_group_algorithms[6].case_func(&m_spdm_test_context);
  return true;
}

bool spdm_test_algorithms_7_teardown(void *test_context)
{
  m_spdm_test_group_algorithms[6].case_teardown_func(&m_spdm_test_context);
  return true;
}
