...
bool spdm_test_certificate_4_setup(void *test_context)
{
  ...
  return m_spdm_test_group_certificate[3].case_setup_func(&m_spdm_test_context);
}

bool spdm_test_certificate_4_run(void *test_context)
{
  m_spdm_test_group_certificate[3].case_func(&m_spdm_test_context);
  return true;
}

bool spdm_test_certificate_4_teardown(void *test_context)
{
  m_spdm_test_group_certificate[3].case_teardown_func(&m_spdm_test_context);
  return true;
}
